...
;
const metadata = {
    title: "Салон Красоты - Онлайн запись к парикмахеру",
    description: "Профессиональные услуги парикмахера с удобной онлайн-записью. Опытные мастера, современные техники окрашивания и стрижки.",
    generator: "v0.app",
    icons: {
        icon: [
            {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1548e6d1._.js.map